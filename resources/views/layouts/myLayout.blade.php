        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                ...
                                <span class="text-muted text-xs block">Director de Parques y Jardines <b class="caret"></b></span>
                            </a>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-map"></i> <span class="nav-label">Taller</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="{{route('home')}}">My Taller</a></li>
                            <!-- <li><a href="#">Agrega</a></li>
                            <li><a href="#">Mapa SCZ Poligono</a></li> -->
                        </ul>
                    </li>
